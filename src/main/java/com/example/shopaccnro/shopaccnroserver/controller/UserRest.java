...
import com.example.shopaccnro.shopaccnroserver.entity.User;
import com.example.shopaccnro.shopaccnroserver.request.UserRequest;
import com.example.shopaccnro.shopaccnroserver.service.UserService;
        ...
        List<UserRequest> userRequests = users.stream()
                .map(user -> {
                    ...
                    if (user.getAccount() != null && user.getAccount().getRole() != null) {
                        ...
                        userRequest.setAccountId(user.getAccount().getId());
